...
if (isset($_POST['modifyService'])) { ?>
    ...
    <?php $res = modifyService($pdo, $service['se_id'], $_POST['se_info']);
    if ($res) {
...
<?php if (!$error) { ?>
    ...
    <div class="d-flex justify-content-center">
        <img src="<?=_SERVICES_IMAGES_FOLDER_.$service['se_images'];?>" alt="image-service">
    </div>
    ...
    <?php if (isset($_SESSION['user'])) {
        if ($_SESSION['user']['us_role']=='employe') { ?>
            <a class="btn btn-primary btn-sm js-button-modifier-services mb-3" data-bs-toggle="collapse" href="#collapseModifyService" role="button" aria-expanded="false" aria-controls="collapseExample" id="button-modifier-services">Modifier</a>
