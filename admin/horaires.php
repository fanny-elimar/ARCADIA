...
if (isset($_POST['addHoraire'])) { 
    ...
    if (!$errors) {?>
        <!--empecher le renvoi du formulaire à l'actualisation de la page-->
                        ...
                        <?php
      $res = addHoraire($pdo, $_POST['ho_periode_start'], $_POST['ho_periode_end'], $_POST['ho_days'], $_POST['ho_time_start'], $_POST['ho_time_end']);
      if ($res) {
            ...
            if (isset($_POST['updateHoraire'.$horaire['ho_id']])) { 
                ...
                if (!$errors) {?>
                    <!--empecher le renvoi du formulaire à l'actualisation de la page-->
                        <script> location.replace(document.referrer); </script>
        <?php
                    $res2 = updateHoraire($pdo, $_POST['ho_periode_start'], $_POST['ho_periode_end'], $_POST['ho_days'], $_POST['ho_time_start'], $_POST['ho_time_end'], $horaire['ho_id']);
                    if ($res2) {
...
if (isset($_POST['deleteHoraire'.$horaire['ho_id']])) { 
                ...
                if (!$errors) {?>
                    <!--empecher le renvoi du formulaire à l'actualisation de la page-->
                        <script> location.replace(document.referrer); </script>
        <?php
                    $res3 = deleteHoraire($pdo, $horaire['ho_id']);
                    if ($res2) {
