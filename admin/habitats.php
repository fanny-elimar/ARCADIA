...
<h3 class="display-5">Gestion des habitats</h3>
...
<div class="">
    <?php foreach ($habitats as $habitat) {
        ...
        <div class="row d-flex mb-3 align-items-center">
            ...
            <div class=" p-0">
                <form method="POST">
                    <button type="submit" name="deleteHabitat<?= $habitat['ha_id']?>" class="btn btn-primary btn-sm" value="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet habitat ?')"><img src="../assets/icones/delete.png" height="15"></button>
                </form>
            </div>
            </div>
        </div>
