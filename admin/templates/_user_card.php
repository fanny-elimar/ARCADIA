<div class="card m-1 light" style="width:15rem; height:8rem;" >
  <div class="card-body justify-content-center">
    ...
    <div class="row">
      ...
      <div class="col">
        <form method='POST'>
          <button type="submit" name="<?php echo 'deleteUser'.$user['us_id'];?>" class="btn btn-primary btn-sm" value="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?')"><img src="../assets/icones/delete.png" height="15"></button>
        </form>
      </div>
    </div>
  </div>
