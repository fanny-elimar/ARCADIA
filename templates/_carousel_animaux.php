...
<?php  
$list = opendir(_ANIMALS_IMAGES_FOLDER_);
$tabfile = array();
...
<div id="carousel-animal-sm" class="carousel slide carousel-fade d-md-none" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-interval="4000">
      <div class="row d-flex justify-content-around align-item-center">
        <div class="col-11">
          <img src="<?=_ANIMALS_IMAGES_FOLDER_. $tabfile[1];?>" alt="Carrousel slide 1" class="d-block img-fluid  h-100 object-fit-contain" >
        </div>
      </div>
    </div>
    <?php for ($i=2;$i<=9;$i++) {?>
      <div class="carousel-item " data-interval="2000">
        <div class="row d-flex justify-content-around align-item-center">
          <div class="col-11">
            <img src="<?=_ANIMALS_IMAGES_FOLDER_. $tabfile[$i];?>" alt="Carrousel slide 1" class="d-block img-fluid  h-100 object-fit-contain" >
          </div>
        </div>
      </div>
    <?php }?>
